...
class Player extends AcGameObject {
    ...
    move_to(tx, ty) {
        ...
        // console.log("move_length : ", this.move_length);
        let angle= Math.atan2(ty - this.y, tx - this.x);
...
class MultiPlayerSocket {
    constructor(playground) {
        this.playground = playground;
        this.ws = new WebSocket('wss://app3243.acapp.acwing.com.cn/wss/multiplayer/');
...
<div class="ac-game-settings">
    <div class="ac-game-settings-login">
        ...
        <div class="ac-game-settings-acwing">
            <img width="30" src="https://app3243.acapp.acwing.com.cn/static/image/settings/acwing_logo.png">
            <br>
            <div>
                AcWing一键登录
            </div>
...
`);
    ...
    acwing_login() {
        $.ajax({
            url: "https://app3243.acapp.acwing.com.cn/settings/acwing/web/apply_code/",
            type: "GET",
    ...
    login_on_remote() {
        ...
        $.ajax({
            url: "https://app3243.acapp.acwing.com.cn/settings/login",
            type: "GET",
            data: {
                username : username,
                password : password,
    ...
    logout_on_remote() {
        ...
        $.ajax({
            url: "https://app3243.acapp.acwing.com.cn/settings/logout/",
            type: "GET",
            success: function(resp) {
                console.log(resp);
                if(resp.result === "success") {
    ...
    register_on_remote() {
        ...
        $.ajax({
            url: "https://app3243.acapp.acwing.com.cn/settings/register",
            type: "GET",
            data: {
                username : username,
                password : password,
    ...
    getinfo() {
        ...
        $.ajax({
            url: "https://app3243.acapp.acwing.com.cn/settings/getinfo/",
            type: "GET",
            data: {
